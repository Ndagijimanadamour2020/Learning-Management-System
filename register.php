...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="images/logo1.png" width="2%"height="2%" alt="IMG"> CYONDO TSS
      <br>Nyagatare || Kiyombe Sector
      <p class="subtitle"> Schools for a better for a future.</p> 
  </div>
</section> 
...
if (isset($_POST['btnRegister'])) {
    ...
    message("You are now registered succefully. You can login now!","success");
    redirect("register.php");
}

?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; CYONDO TECHNICAL SECONDARY SCHOOL. <?php echo date("Y"); ?></p>
     </footer>
 </section>
