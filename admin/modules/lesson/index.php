...
<body>
    ...
    <div id="sidebar" class="bg-dark text-white p-3">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active text-white" href="<?php echo web_root; ?>admin/modules/lesson/index.php">
                    <i class="fas fa-book me-2"></i> Lessons
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo web_root; ?>admin/modules/exercises/index.php">
    ...
    <div id="content" class="bg-light">
        <div class="container-fluid">
            <h3 class="mb-4">Lesson Management</h3>
